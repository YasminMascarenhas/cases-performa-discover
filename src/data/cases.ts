...
import jllTeamCover from "@/assets/jll-team.png.asset.json";
...
export const segments: Segment[] = [
  ...
  { name: "Serviços", icon: Briefcase, projects: [{ company: "HPE", title: "IA para Forecast Financeiro", logo: hpeLogo.url }, { company: "JLL", title: "IA para Forecast Financeiro", logo: jllLogo.url }] },
