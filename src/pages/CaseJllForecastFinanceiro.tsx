...
import sideImage from "@/assets/jll-team.png.asset.json";
...
const CaseJllForecastFinanceiro = () => {
  return (
        ...
        <div className="container mx-auto px-6 py-16">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="flex justify-center">
              <img
                src={sideImage.url}
                alt="JLL — Equipe Performa IT"
                className="max-h-[520px] w-full rounded-2xl object-cover shadow-elevated"
              />
            </div>
          </div>
        </div>
...
export default CaseJllForecastFinanceiro;
