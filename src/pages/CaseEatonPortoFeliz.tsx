import { ArrowLeft, Target, Lightbulb, TrendingUp, Clock, ClipboardList, Smartphone } from "lucide-react";
import { Link } from "react-router-dom";
import { EatonCompanyHeader } from "@/components/EatonCompanyHeader";
import mockup from "@/assets/eaton-porto-feliz-mockup.png.asset.json";

const bullets = [
  "Redução de processos manuais",
  "Integração de informações em tempo real",
  "Foco em eficiência e autonomia do time",
];

const metrics = [
  { icon: Clock, value: "10min", label: "Tempo de envio da proposta" },
  { icon: ClipboardList, value: "+520", label: "Propostas elaboradas" },
  { icon: Smartphone, value: "+120", label: "Propostas ganhas no aplicativo" },
];

const CaseEatonPortoFeliz = () => {
  return (
        ...
        <div className="container mx-auto px-6 py-16">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="space-y-10">
              <div>
                ...
                <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                  Melhorar o processo de orçamentos, reduzindo tarefas manuais e otimizando o tempo
                  da equipe para focar em atividades mais estratégicas.
                </p>
              </div>
              ...
              <div>
                ...
                <h2 className="mt-5 text-2xl font-bold text-foreground">
                  Solução — Eaton Porto Feliz: Power Systems + Power BI
                </h2>
                <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                  Aplicativo para gestão de propostas comerciais com automação de processos e mais
            ...
            <div className="flex justify-center">
              <img
                src={mockup.url}
                alt="Eaton Porto Feliz — mockup smartphone"
...
export default CaseEatonPortoFeliz;
